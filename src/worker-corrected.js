/**
 * Ghost Reactions Worker - CORRECTED VERSION
 * Handles reaction counting using Cloudflare Durable Objects
 */

// Durable Object Class (KEIN extends DurableObject needed!)
...
function serveWidget(env) {
  const workerUrl = env.WORKER_URL || `https://${env.CF_WORKER_HOST || 'ghost-reactions.workers.dev'}`;
